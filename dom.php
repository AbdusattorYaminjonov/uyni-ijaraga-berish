...
?>
    <main id="main">
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-8">
                        <div class="title-single-box">
                            <h1 class="title-single">Dom/Kvartira</h1>
                            <span class="color-text-a">qulay</span>
                        </div>
                    </div>
        ...
        <!-- ======= Property Grid ======= -->
        <?php
        $query = "SELECT * FROM uy WHERE type_id=3";
            ...
            echo "
                    <div class='postramka'>
                        ...
                        <div class='item'>
                              ...
                              <a href='about_home.php?id={$line['id']}'>To'liq ma'lumot</a>
                        </div>
                    </div>
        ";
