...
?>
  ...
  <div class="intro intro-carousel swiper position-relative">
    <div class="swiper-wrapper">
      <?php
        $query = "SELECT * FROM uy ";
        $result = mysqli_query($link, $query) or die("So'rov ishlamadi : " . mysqli_error($link));
        while ($line = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
            echo "
              <div class='swiper-slide carousel-item-a intro-item bg-image' style='background-image: url({$line['photo']})'>
                      ...
                      <div class='row'>
                        <div class='col-lg-8'>
                          <div class='intro-body'>
                            <p class='intro-title-top'>New house
                              <br> yangi uy
                            </p>
                            <h1 class='intro-title mb-4 '>
                              <span class='color-b'>NEW </span>{$line['headline']}
                            </h1>
                            <p class='intro-subtitle intro-price'>
                              <a href='#'><span class='price-a'>Oyiga | $ {$line['price']}</span></a>
                            </p>
                          </div>
                        </div>
                      </div>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="title-wrap d-flex justify-content-between">
              <div class="title-box">
                <h2 class="title-a">Bizning Hizmatlarimiz</h2>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="card-box-c foo">
              <div class="card-header-c d-flex">
                ...
                <div class="card-title-c align-self-center">
                  <h2 class="title-c">Maxsulotlar</h2>
                </div>
              </div>
          ...
          <div class="col-md-4">
            <div class="card-box-c foo">
              <div class="card-header-c d-flex">
                ...
                <div class="card-title-c align-self-center">
                  <h2 class="title-c">Salomatlik</h2>
                </div>
              </div>
              <div class="card-body-c">
                <p class="content-c">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <div class="title-wrap d-flex justify-content-between">
              <div class="title-box">
                <h2 class="title-a">Yangi turar joylar</h2>
              </div>
                ...
                <div class='card-overlay'>
                  <div class='card-overlay-a-content'>
                    ...
                    <div class='card-body-a'>
                      ...
                      <a href='about_home.php?id={$line1['id']}' class='link-a'>Ko'proq
                        <span class='bi bi-chevron-right'></span>
                      </a>
                    </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <div class="title-wrap d-flex justify-content-between">
              <div class="title-box">
                <h2 class="title-a">Bizning Hodimlar</h2>
              </div>
